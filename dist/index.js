...
var savePushSubscription = (userId3, input, userAgent) => {
  ...
  return prisma_default.pushSubscription.upsert({
    ...
    create: { endpoint: input.endpoint, p256dh: input.keys.p256dh, auth: input.keys.auth, user_agent: userAgent ?? null, user_id: userId3 },
    update: { p256dh: input.keys.p256dh, auth: input.keys.auth, user_agent: userAgent ?? null, user_id: userId3 },
